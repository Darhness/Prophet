...
import websocket
from config.binanceConfig import BINANCE_SOCKET_API_URL
...
class KlineRequest:
    ...
    def __str__(self) -> str:
        ...
        startTime = "" if self.startTime is None else "&startTime={}".format(
            self.startTime)
        endTime = "" if self.endTime is None or self.startTime is None else "&endTime={}".format(
            self.endTime)
        limit = "&limit={}".format(
